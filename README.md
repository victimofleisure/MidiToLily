...
If you're specifying many parameters, instead of editing a long command line, you may prefer to put your parameters in a text file. That way each parameter can have its own line, making them easier to read and edit. Pass your text file to MidiToLily via the -params parameter, like so:
