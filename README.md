...
If you're specifying many parameters, instead of a editing long command line, you may prefer to put your parameters in a text file. This way each parameter can have its own line, making them easier to edit. Pass the text file to MidiToLily via the -params parameter, like so:
