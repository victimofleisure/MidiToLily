...
If you're specifying many parameters, instead of editing a long command line, you may prefer to put your parameters in a text file. Pass the text file to MidiToLily via the -params parameter, like so:
